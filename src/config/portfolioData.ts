        ...
        content: [
          ...
          { type: "responsibilities" },
          {
            ...
            media: {
              ...
              caption: "Observing creature interactions to understand their behavior.",
              fit: "contain",
            },
          },
          {
            type: "text-media",
            heading: "GOAP Agents",
            body: "To encourage players to learn creature behavior, I developed agents using Goal-Oriented Action Planning (GOAP), a game AI approach that lets NPCs choose actions based on their current goals. For example, a hungry creature can search for prey, pursue and attack it, or look for inert food and eat it. It chooses the viable sequence of actions that requires the least effort in the current situation.",
            media: {
              src: "projects/unleash/goap-agents.gif",
              alt: "GOAP-controlled creatures choosing actions around food and other creatures",
              caption: "Accelerated behavior test at 30× game speed to verify expected behavior over time.",
              fit: "contain",
            },
          },
          {
            type: "text-media",
            heading: "Modular AI Systems",
            body: "The AI architecture is built from reusable goals, actions, and strategies that developers can combine to create different creature behaviors with little or no additional code. It connects to a configurable food chain that defines what each species can eat, including members of its own species, and whether it consumes inert food or hunts live prey.",
            media: {
              src: "projects/unleash/goap-food-chain-inspector.png",
              alt: "Unity Inspector configuration for GOAP goals, actions, and species diet",
